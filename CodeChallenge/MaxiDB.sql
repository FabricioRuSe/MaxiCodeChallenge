...
CREATE DATABASE [MaxiDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MaxiDB', FILENAME = N'/var/opt/mssql/data/MaxiDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'MaxiDB_log', FILENAME = N'/var/opt/mssql/data/MaxiDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
